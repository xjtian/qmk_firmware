 ...
 * |-------+------+------+-------+------+---------+-------+----------+-------+--------+------+-----------|
 * | Play  |L(Fn) | Alt  |   OS  |L(Sym)|Shft/Bksp| Space |Ent/L(Num)|OS/Left|Alt/Down|Ctl/Up|   Right   |
 * `-----------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    KC_MPLY,        MOF,   KC_LALT, KC_LGUI,  MOS,  SFT_T(KC_BSPC), KC_SPC, LTN,  GUI_T(KC_LEFT), ALT_T(KC_DOWN), CTL_T(KC_UP),   KC_RGHT
),
