 ...
 * |-------+------+------+-------+------+---------+-------+----------+-------+--------+------+-----------|
 * |  Ctrl |L(Fn) | Alt  |   OS  |L(Sym)|Shft/Bksp| Space |Ent/L(Num)|OS/Left|Alt/Down|Ctl/Up|   Right   |
 * `-----------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL,        MOF,   KC_LALT, KC_LGUI,  MOS,  SFT_T(KC_BSPC), KC_SPC, LTN,  GUI_T(KC_LEFT), ALT_T(KC_DOWN), CTL_T(KC_UP),   KC_RGHT
),


/* Numbers
 * ,-------------------------------------------------------------------------.
 * |  v   |  1  |  2  |  3  |  4  |  5  |  6  |  7  |  8  |  9  |  0  | Bksp |
 * |------+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+------|
 * |  v   |  4  |  5  |  6  |     |     |     |  4  |  5  |  6  |     |      |
 * |------+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+------|
 * |  v   |  7  |  8  |  9  |  0  |     |  ,  |  1  |  2  |  3  |  .  |  v   |
...
[_NUM] = LAYOUT_ortho_4x12(
    ...
    _______, KC_4,    KC_5,    KC_6,    KC_NO, KC_NO,   KC_NO,   KC_4,    KC_5,    KC_6,    KC_NO,    KC_NO,
    _______, KC_7,    KC_8,    KC_9,    KC_0,  KC_NO,   KC_COMM, KC_1,    KC_2,    KC_3,    KC_DOT,   _______,
...
[_ADJUST] = LAYOUT_ortho_4x12(
    KC_NO, KC_NO, RGB_TOG, RGB_MOD, RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, KC_NO, KC_NO,
